...
# List of repositories with their Jenkins pipeline types
# Format: "repo_name|git_url|has_build|has_deploy"
...
JENKINS_USER="arpansahu"
JENKINS_PASSWORD="Gandu302@jenkins"
